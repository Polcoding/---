...
- 다만 외부 서비스 전송 전 실제 원문 차단과 비식별 입력 확인 절차는 아직 별도 상세화가 필요합니다.
...
다음 단계는 외부 연동 구현이 아니라 실제 원문 차단과 비식별 입력 확인 절차를 문서 기준으로 구체화하는 것입니다.
...
다음 단계는 실제 원문 차단과 비식별 입력 확인 절차를 문서 기준으로 구체화하는 것입니다.
