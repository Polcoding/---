...
Phase 3 첫 작업은 다음 순서로 진행합니다.

1. 안전 게이트 문서와 체크리스트 고정
2. 저장소 밖 HWPX 양식 취급 절차 재확인
3. 사용자 수동 preview 체크리스트 정리
4. 상태별 중단 기준을 반복 운영 문서에 반영할지 검토
5. 외부 연동 필요성은 별도 문서에서 후순위 검토
...
다음 단계는 저장소 밖 HWPX 양식 취급 기준과 사용자 수동 preview 기준을 Phase 3 흐름에 맞춰 더 구체화하는 것입니다.
