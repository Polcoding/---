...
| [ ] | 수동 preview 재개 전 `docs/150_manual_preview_resume_gate.md` 조건 확인 |
| [ ] | 사용자 가시 산출물 보안ㆍGit 제외 검증 상태 확인 |
