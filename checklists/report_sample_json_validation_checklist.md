...
- [ ] 표 데이터 후보 필드를 HWPX payload 확장처럼 추가하지 않았는가

## 표 데이터 후보

- [ ] `renderer_hints.table_template`을 실제 표 데이터가 아니라 서식 또는 표시 후보 힌트로 해석했는가
- [ ] `docs/137_report_sample_json_table_data_candidate_review.md`의 샘플 JSON 직접 수정 보류 결정을 확인했는가
